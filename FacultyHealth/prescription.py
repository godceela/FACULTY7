...
age_entry = Entry(ptntRec_panel, textvariable= address, font=("Microsoft JhengHei", 11), 
                      fg="#497687", width=27)
...
pr_entry = Entry(ptntRec_panel, textvariable= prevCheckup, font=("Microsoft JhengHei", 11), 
                       fg="#497687", width=22)
...
bt_entry = Entry(ptntRec_panel,textvariable= age, font=("Microsoft JhengHei", 11), 
                  fg="#497687", width=22)
...
hbCmbQ1 = Combobox(highBpmPan, font=("Microsoft JhengHei", 11), 
                            values=["Recently (few hours/days ago)", 
                                    "Past week/s", "About a month ago"], width=23)
...
hbLabQ4 = Label(highBpmPan, text="Have you experienced any \nirregular heartbeats \nor palpitations?", font=("Microsoft JhengHei", 11, "bold"), 
                   bg="#FBF0D7", fg="#497687", justify="left")
hbLabQ4.place(relx=0.05, rely=0.826)
hbCmbQ4 = Combobox(highBpmPan, font=("Microsoft JhengHei", 11), 
                   values=["Yes, occasionally", "Yes, a few instances",
                           "No, I haven't experienced"], width=23)
hbCmbQ4.place(relx=0.73, rely=0.86, anchor=CENTER)
